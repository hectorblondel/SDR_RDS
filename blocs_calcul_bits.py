...
import blocs_calcul_bits_epy_block_0_0_0 as epy_block_0_0_0  # embedded python block
import blocs_calcul_bits_epy_block_1 as epy_block_1  # embedded python block



from gnuradio import qtgui

class blocs_calcul_bits(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "blocs_calcul_bits")
        ...
        self.samp_rate = samp_rate = 304000
        ...
        self.qtgui_eye_sink_x_0_0.set_y_label('Amplitude', "Diagramme de l'oeil après filtrage")
        ...
        self.qtgui_const_sink_x_0_3_0 = qtgui.const_sink_c(
            1024, #size
            "", #name
            1, #number of inputs
            None # parent
        )
        self.qtgui_const_sink_x_0_3_0.set_update_time(0.10)
        self.qtgui_const_sink_x_0_3_0.set_y_axis((-2), 2)
        self.qtgui_const_sink_x_0_3_0.set_x_axis((-2), 2)
        self.qtgui_const_sink_x_0_3_0.set_trigger_mode(qtgui.TRIG_MODE_FREE, qtgui.TRIG_SLOPE_POS, 0.0, 0, "")
        self.qtgui_const_sink_x_0_3_0.enable_autoscale(True)
        self.qtgui_const_sink_x_0_3_0.enable_grid(False)
        self.qtgui_const_sink_x_0_3_0.enable_axis_labels(True)
        ...
        for i in range(1):
            if len(labels[i]) == 0:
                self.qtgui_const_sink_x_0_3_0.set_line_label(i, "Data {0}".format(i))
            else:
                self.qtgui_const_sink_x_0_3_0.set_line_label(i, labels[i])
            self.qtgui_const_sink_x_0_3_0.set_line_width(i, widths[i])
            self.qtgui_const_sink_x_0_3_0.set_line_color(i, colors[i])
            self.qtgui_const_sink_x_0_3_0.set_line_style(i, styles[i])
            self.qtgui_const_sink_x_0_3_0.set_line_marker(i, markers[i])
            self.qtgui_const_sink_x_0_3_0.set_line_alpha(i, alphas[i])

        self._qtgui_const_sink_x_0_3_0_win = sip.wrapinstance(self.qtgui_const_sink_x_0_3_0.qwidget(), Qt.QWidget)
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_0_3_0_win, 0, 0, 1, 1)
        for r in range(0, 1):
        ...
        self._qtgui_const_sink_x_0_2_0_0_win = sip.wrapinstance(self.qtgui_const_sink_x_0_2_0_0.qwidget(), Qt.QWidget)
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_0_2_0_0_win, 1, 0, 1, 1)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.qtgui_const_sink_x_0_1_0_1.enable_grid(False)
        ...
        self._qtgui_const_sink_x_0_1_0_1_win = sip.wrapinstance(self.qtgui_const_sink_x_0_1_0_1.qwidget(), Qt.QWidget)
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_0_1_0_1_win, 0, 1, 1, 1)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.qtgui_const_sink_x_0_1_0_0_0.enable_grid(False)
        ...
        self.top_layout.addWidget(self._qtgui_const_sink_x_0_1_0_0_0_win)
        ...
        self.epy_block_0_0_0 = epy_block_0_0_0.blk(t0=00, nb_ech_par_symb=8)
        self.blocks_float_to_complex_1_4 = blocks.float_to_complex(1)
        self.blocks_float_to_complex_1_2 = blocks.float_to_complex(1)
        self.blocks_float_to_complex_1_1 = blocks.float_to_complex(1)
        self.blocks_float_to_complex_1_0 = blocks.float_to_complex(1)
        self.blocks_float_to_complex_1 = blocks.float_to_complex(1)
        self.blocks_file_source_1 = blocks.file_source(gr.sizeof_float*1, '/home/hector/Documents/scolaire/CentraleSupelec/2A/Découverte de la radio logicielle/toto1', True, 0, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_file_source_1, 0), (self.epy_block_0_0_0, 0))
        self.connect((self.blocks_file_source_1, 0), (self.qtgui_eye_sink_x_0_0, 0))
        self.connect((self.blocks_float_to_complex_1, 0), (self.qtgui_const_sink_x_0_3_0, 0))
        self.connect((self.blocks_float_to_complex_1_0, 0), (self.qtgui_const_sink_x_0_2_0_0, 0))
        self.connect((self.blocks_float_to_complex_1_1, 0), (self.epy_block_1, 0))
        self.connect((self.blocks_float_to_complex_1_1, 0), (self.qtgui_const_sink_x_0_1_0_0_0, 0))
        self.connect((self.blocks_float_to_complex_1_2, 0), (self.qtgui_const_sink_x_0_0_0_0, 0))
        self.connect((self.blocks_float_to_complex_1_4, 0), (self.qtgui_const_sink_x_0_1_0_1, 0))
        self.connect((self.epy_block_0_0_0, 0), (self.blocks_float_to_complex_1, 0))
        self.connect((self.epy_block_0_0_0, 2), (self.blocks_float_to_complex_1_0, 0))
        self.connect((self.epy_block_0_0_0, 4), (self.blocks_float_to_complex_1_1, 0))
        self.connect((self.epy_block_0_0_0, 3), (self.blocks_float_to_complex_1_2, 0))
        self.connect((self.epy_block_0_0_0, 1), (self.blocks_float_to_complex_1_4, 0))
    ...
    def set_samp_rate_rds(self, samp_rate_rds):
        ...
        self.qtgui_eye_sink_x_0_0.set_samp_rate(self.samp_rate_rds)
...
def main(top_block_cls=blocs_calcul_bits, options=None):
